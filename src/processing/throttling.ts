import {getOrSet, mergeDefinedProperties, type PartialWithUndefined} from '@augment-vir/common';
 ...
 * @category Internal
 */
export const throttleCache: Record<string, ThrottleCacheEntry> = {};
...
export function shouldThrottleEvent(
    ...
    hint: Readonly<Pick<EventHint, 'originalException'>> | undefined = undefined,
